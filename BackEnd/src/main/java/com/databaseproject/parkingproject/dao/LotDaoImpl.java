...
""";
    ...
    public ResponseMessageDto admitLot(int id) {
        ...
        generateLotSpots(id, parkingLot.getDisabledCount(), "DISABLED");
        generateLotSpots(id, parkingLot.getRegularCount(), "REGULAR");
        generateLotSpots(id, parkingLot.getEVCount(), "EV");
    ...
    private ParkingLots getParkingLot(int id) {
        return jdbcTemplate.queryForObject(SQL_GET_LOT_BY_ID, new Object[]{id},
                (rs, rowNum) -> new ParkingLots(
                        rs.getInt("id"),
                        rs.getObject("disabled_count", Integer.class),
                        rs.getObject("regular_count", Integer.class),
                        rs.getObject("EV_count", Integer.class),
                        rs.getString("location"),
                        rs.getDouble("latitude"),
                        rs.getDouble("longitude"),
                        rs.getObject("parking_lot_manager", Integer.class),
                        rs.getObject("admitted", Boolean.class)
                ));
    }
